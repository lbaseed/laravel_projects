                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="/case/{{ $case->id }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="assignment_date" type="text" class="form-control @error('assignment_date') is-invalid @enderror" name="assignment_date" value="{{ $case->assignment_date }}" required autocomplete="off">
